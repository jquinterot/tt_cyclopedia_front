...
export const ErrorMessages: Record<ErrorCode, string> = {
  ...
  [ErrorCode.DUPLICATE_USERNAME]:
    "Username is already taken. Try adding numbers or special characters to make it unique.",
  [ErrorCode.DUPLICATE_EMAIL]:
    "Email is already registered. Please use a different email address or try signing in.",
  [ErrorCode.DUPLICATE_BOTH]:
    "Both username and email are already taken. Please choose different ones or try signing in instead.",
