...
describe("PostDetails Component", () => {
  ...
  test("renders loading state initially", () => {
    ...
    expect(screen.getByTestId("skeleton-post-detail")).toBeInTheDocument();
  });
  ...
  test("renders equipment badge when post has equipment", () => {
    ...
    const equipmentLink = screen.getByRole("link", {
      name: /Butterfly Viscaria/i,
    });
  ...
  test("does not render equipment badge when post has no equipment", () => {
    ...
    expect(
      screen.queryByRole("link", { name: /equipment/i }),
