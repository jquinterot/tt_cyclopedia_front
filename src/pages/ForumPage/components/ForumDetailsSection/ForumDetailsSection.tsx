...
export default function ForumDetails() {
  ...
  const handleSaveEdit = async () => {
    await updateForum.mutateAsync({ forumId: forum.id, data: { title: editTitle, content: editContent } });
    setIsEditing(false);
  };
        ...
        {isEditing ? (
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <button onClick={handleSaveEdit} disabled={updateForum.isPending}
          ...
          <div>
            <div className="flex items-center justify-between">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl text-center flex-1">{forum.title}</h1>
              {isOwner && (
                <div className="flex gap-2 flex-shrink-0">
                  <button onClick={handleEdit}
                    ...
                    data-testid="edit-forum-button">Edit</button>
                  <button onClick={handleDelete} disabled={deleteForum.isPending}
