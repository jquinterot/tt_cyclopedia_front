    ...
    <section className="flex items-center gap-3">
      ...
      >
        {forum.liked_by_current_user ? (
          <HeartIconFilled
            className="w-7 h-7 text-blue-600 transition-colors"
            data-testid="forum-like-icon-filled"
          />
        ) : (
          <HeartIcon
            className="w-7 h-7 text-blue-400 transition-colors"
            data-testid="forum-like-icon-outline"
          />
        )}
