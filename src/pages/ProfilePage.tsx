...
export default function ProfilePage() {
  ...
  if (!user) {
    return <div className="text-red-400">You must be logged in to view your profile.</div>;
  }

  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white/10 rounded-lg shadow">
