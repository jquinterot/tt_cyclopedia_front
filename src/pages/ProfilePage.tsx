...
export default function ProfilePage() {
  ...
  if (!user) {
    return (
      <>
        ...
        <div className="text-red-400" data-testid="profile-login-required">
  ...
  return (
    <>
      ...
      />
      <div
        className="max-w-md mx-auto mt-10 p-6 bg-white/10 rounded-lg shadow"
      ...
      >
        ...
        <div className="flex flex-col items-center mb-6">
          <div
            className="h-16 w-16 rounded-full bg-blue-600 flex items-center justify-center mb-2"
