        ...
        {filteredPosts.map((post) => (
          ...
          >
            ...
            >
              ...
              {/* Stats */}
              <div
                className="w-full md:w-1/2 flex flex-col justify-center  space-y-6 px-4"
            ...
            <div className="px-6 pb-6" data-testid={`post-details-${post.id}`}>
              <div className=" w-full pt-4 border-t border-white/10">
                <h2
                  className="text-xl font-semibold text-white group-hover:text-blue-400 transition-colors mb-2"
