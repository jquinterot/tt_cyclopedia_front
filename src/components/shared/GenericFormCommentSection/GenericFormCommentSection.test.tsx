...
describe("GenericFormCommentSection", () => {
  ...
  test("renders comment form container", () => {
    render(<GenericFormCommentSection {...mockProps} />, {
      wrapper: createWrapper(),
    });
    expect(
      screen.getByTestId("test-comment-form-container"),
    ).toBeInTheDocument();
  });
  ...
  test("renders sign in link when not authenticated", () => {
    render(
      <GenericFormCommentSection {...mockProps} isAuthenticated={false} />,
      { wrapper: createWrapper() },
    );
  ...
  test("renders comments list when there are comments", () => {
    ...
    expect(
      screen.getByTestId("test-comments-list-container"),
    ).toBeInTheDocument();
  });
});
